...
namespace EmpireVendas
{
    public partial class Menu : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            txtPaginaInicial.ForeColor = Color.Orange;
            btnRecebimentos.ForeColor = Color.White;
        ...
        private void btnRecebimentos_Click(object sender, EventArgs e)
        {
            abrirFormInPanel(new Recebimentos());
            btnProdutos.ForeColor = Color.White;
            btnVendas.ForeColor = Color.White;
            btnCategorias.ForeColor = Color.White;
            btnClientes.ForeColor = Color.White;
            ...
            btnRelatorios.ForeColor = Color.White;
            txtPaginaInicial.ForeColor = Color.White;
            btnRecebimentos.ForeColor = Color.Orange;
        }
    }
}
