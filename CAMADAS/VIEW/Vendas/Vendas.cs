...
namespace EmpireVendas
{
    public partial class Vendas : Form
    {
        ...
        private void btnNovo_Click(object sender, EventArgs e)
        {
            ...
            txtTotal.Text = somaTotais().ToString();
            txtSubTotal.Text = somaSubTotais().ToString();
        }
        ...
        private void inserirDadosTabelaItens()
        {
        ...
        {
            CadastrarClientes abrir = new CadastrarClientes(this);
            abrir.Show();
        }
        ...
        {
            txtIdTipoVenda.Text = cmbTipoVenda.SelectedValue.ToString();
        }
    }
}
